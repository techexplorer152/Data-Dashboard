...
const FloatingCardTemplate = () => {
    return (
        <div id="floating-card-render" className={styles.cardContainer}>
            <h2 className={styles.title}>World Economic Growth (1960 – NOW)</h2>
            ...
            <div className={styles.content}>
                <div className={styles.chartSection}>
                    <div className={styles.legend}>
                        ...
                        <div className={styles.legendItem}>
                            <span className={`${styles.dot} ${styles.bgSeries3}`}></span>
                    ...
                    <svg viewBox="0 0 200 100" className={styles.svgChart} preserveAspectRatio="none">
                        ...
                        <polyline points="0,80 50,60 100,75 150,40 200,35" fill="none" stroke="#2b5a7d" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        ...
                        <polyline points="0,100 50,90 100,20 150,60 200,55" fill="none" stroke="#87e3f1" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                ...
                <div className={styles.statsSection}>
                    <StatRow img={UnFlag} val1="100,000,000" val2="2.5%" />
